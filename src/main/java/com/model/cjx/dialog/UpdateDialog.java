...
import com.model.cjx.http.ProgressResponseListener;
...
public class UpdateDialog extends BaseDialog implements View.OnClickListener {
    ...
    private void init() {
        ...
        View v = View.inflate(getContext(), R.layout.dialog_update, null);
    ...
    public UpdateDialog setText(String title, String describe, String comfirm, String url) {
    ...
    private void startDownload() {
        ...
        tempFile = new File(Tools.getTempPath(getContext()), ".temp");
        if (tempFile.exists()) {
            tempFile.delete();
        }
