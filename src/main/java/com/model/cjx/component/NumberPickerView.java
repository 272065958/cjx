...
//    private int mMaxValue = 0;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mDividerColor = a.getColor(R.styleable.NumberPickerView_npv_DividerColor, ContextCompat.getColor(getContext(), R.color.cjx_colorPrimary));
        ...
        mTextColorSelected = a.getColor(R.styleable.NumberPickerView_npv_TextColorSelected, ContextCompat.getColor(getContext(), R.color.cjx_colorPrimary));
        mTextColorHint = a.getColor(R.styleable.NumberPickerView_npv_TextColorHint, ContextCompat.getColor(getContext(), R.color.cjx_colorPrimary));
